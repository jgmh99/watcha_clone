        ...
        <Row style={{ boxSizing:'border-box', border:'3px solid red', height:'auto'}}>
          ...
          <div style={{width:'100%',height:'100%', border:'1px solid blue',padding:'0px',position:'absolute',zIndex:'99',background: 'linear-gradient(0.25turn, black 50%, transparent),linear-gradient(1turn, black 2%, transparent )', boxSizing:'border-box'}}>
            <div style={{border:'1px solid red',position:'absolute', bottom:'0', width:'50%', padding:'0.5em'}}>
              <h3>{movie.title}</h3>
              <p style={{fontSize:'14px'}}>{movie.tagline} <span> <Button onClick={() => setShow(true)} style={{padding:'0 0 0 5px', fontSize:'1em', backgroundColor:'transparent', border:'none', textDecoration:'underLine'}}>
                더보기
              </Button></span></p>
              ...
              >
                ...
                <Modal.Body>
                  ...
                  <div style={{ display:'grid', gap: '12px 10px', gridTemplateColumns: 'minmax(56px, auto) 1fr', gap:'13px'}}>
                    ...
                    <p style={{fontSize: '13px',fontWeight: '400',letterSpacing: '0',lineHeight: '18px', color:'#babac1'}}>{movie.release_date}</p>
